...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile UsualWork
  ...
  <sch:pattern>
    <sch:title>Observation.effectivePeriod</sch:title>
  ...
  <sch:pattern>
    <sch:title>Observation.component.valueQuantity.extension</sch:title>
    <sch:rule context="f:Observation/f:component/f:valueQuantity/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.component.valueQuantity.value</sch:title>
    <sch:rule context="f:Observation/f:component/f:valueQuantity/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.component.valueQuantity.comparator</sch:title>
    <sch:rule context="f:Observation/f:component/f:valueQuantity/f:comparator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.component.valueQuantity.unit</sch:title>
    <sch:rule context="f:Observation/f:component/f:valueQuantity/f:unit">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.component.valueQuantity.system</sch:title>
    <sch:rule context="f:Observation/f:component/f:valueQuantity/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.component.valueQuantity.code</sch:title>
    <sch:rule context="f:Observation/f:component/f:valueQuantity/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
